              ...
              {files.map((f) => {
                ...
                return (
                  <div
                    ...
                    className="grid grid-cols-[1fr_80px_80px_100px_40px] gap-4 items-center px-5 py-3 hover:bg-muted/30 transition-colors group"
                  >
                    {/* File name + icon */}
                    <div className="flex items-center gap-3 min-w-0">
                      <div className={cn(
                        "w-9 h-9 rounded-xl flex items-center justify-center shrink-0",
                        isImage ? "bg-blue-500/10 text-blue-500" : "bg-primary/10 text-primary",
                      )}>
                        <Icon size={16} />
                      </div>
