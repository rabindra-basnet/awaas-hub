...
//   file: File;
//   url: string;
//   uploadProgress?: number; // 0 = uploading, -1 = failed, 100 = done
//   fileId?: string;
// };
...
//                     <div className="absolute inset-0 bg-red-500/80 rounded-lg flex items-center justify-center text-white text-xs">
//                       Upload Failed
//                     </div>
//                   )}
    ...
    for (let i = 0; i < images.length; i++) {
      ...
      try {
        ...
        const interval = setInterval(() => {
          ...
          setImages((prev) =>
            prev.map((p, idx) =>
              idx === i ? { ...p, uploadProgress: Math.floor(progress) } : p,
            ),
          );
        }, 200);
            ...
            {images.map((img, i) => (
              <div key={i} className="relative group">
                ...
                {img.uploadProgress !== undefined &&
                  img.uploadProgress < 100 &&
                  img.uploadProgress >= 0 && (
                    <div className="absolute inset-0 bg-black/40 rounded-lg flex flex-col items-center justify-center text-white text-xs">
                      <div className="w-3/4 bg-gray-300 rounded-full h-2 mb-2 overflow-hidden">
                        <div
