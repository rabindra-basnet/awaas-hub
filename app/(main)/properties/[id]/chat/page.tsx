...
// app/properties/[id]/contact/page.tsx
// Replace the message dialog section with InAppChat
...
import InAppChat from "../../_components/InAppChat";
// import InAppChat from "./_components/InAppChat"; // ← NEW
...
const MOCK_SELLER = {
  ...
  bio: "Property specialist with 8+ years in Kathmandu Valley real estate.",
        ...
        <div className="space-y-3 pt-1">
          {[
            ...
            },
            {
              ...
              value: (seller.rating / 5) * 100,
              display: `${seller.rating} / 5`,
              color: "bg-amber-400",
            },
          ].map((bar) => (
            <div key={bar.label}>
              <div className="flex justify-between text-[10px] text-muted-foreground mb-1.5 font-semibold">
                <span>{bar.label}</span>
                <span>{(bar as any).display ?? `${bar.value}%`}</span>
              </div>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-[10px] text-amber-600/80 dark:text-amber-500/80 leading-relaxed">
                    Unlock full contact details, direct email, messaging & chat.
                  </p>
                  <Button
                    size="sm"
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="relative z-10 w-full max-w-[95vw] mx-auto px-4 lg:px-6 py-6 space-y-6">
        ...
        {/* ── IN-APP CHAT — replaces the old dialog ── */}
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            <MessageCircle size={15} className="text-primary" />
            <h2 className="text-sm font-bold">Direct Message</h2>
            {!isPremium && (
              <Badge
                variant="outline"
                className="text-[9px] gap-1 border-amber-400/50 text-amber-600 font-bold ml-auto"
              >
                <Crown size={9} />
                Premium
              </Badge>
