...
import { useProperty, useUpdateProperty } from "@/hooks/services/useProperties";
...
export default function EditPropertyPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    if (authorized === null || isLoading) return <div className="min-h-screen flex items-center justify-center">Loading...</div>;
    ...
    return (
        <div className="max-w-2xl mx-auto py-12 px-4">
            ...
            <PropertyForm
                ...
                onSubmit={(values: any) => update.mutate({ id, ...values }, {
                    onSuccess: () => {
