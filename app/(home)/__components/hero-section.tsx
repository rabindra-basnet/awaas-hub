...
//   const handleUseMyLocation = () => {
//     if (!navigator.geolocation) {
//       toast.error(language === "en" ? "Geolocation not supported" : "स्थान पत्ता लगाउन समर्थित छैन");
//       return;
//     }
...
//       },
//       () => {
//         toast.error(language === "en" ? "Location access denied" : "स्थान पहुँच अस्वीकृत");
//         setIsLocating(false);
//       },
//       { enableHighAccuracy: true },
//     );
...
//   return (
//     <section className="relative h-full py-16 px-6 bg-linear-to-br from-background to-muted/30 dark:from-background dark:to-muted/10 overflow-hidden">
//       <div className="mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
//         <div className="relative z-30">
//           <h1 className="text-5xl lg:text-6xl font-bold leading-tight text-foreground">
//             {t("hero.headline")}
//             <span className="block text-primary mt-2">
//               {t("hero.subheadline")} {currentCity || t("hero.defaultCity")}
//             </span>
//           </h1>
...
//             >
//               <LocateFixed className="h-5 w-5" />
//               {isLocating ? t("hero.locating") : t("hero.useLocation")}
//             </Button>
//           </div>
//         </div>
...
export default function HeroSection({
  ...
  const { isLoading: isReverseLoading } = useReverseGeocode(
    userLat,
    userLon
  );
  ...
  return (
    <section className="relative py-20 px-6 bg-background">
      {/* subtle glow (fixes boring flat look without breaking dark mode) */}
      ...
      <div className="mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-6">
          ...
          {/* SEARCH CARD */}
          <div className="bg-card border border-border rounded-2xl p-5 shadow-sm backdrop-blur supports-[backdrop-filter]:bg-card/80">
        ...
        {/* RIGHT MAP */}
        <div className="rounded-3xl overflow-hidden border border-border bg-card shadow-sm h-[420px] lg:h-[520px]">
          <Suspense fallback={<Skeleton className="h-full w-full" />}>
            <LeafletMap
              center={mapCenter}
              mapRef={mapRef}
