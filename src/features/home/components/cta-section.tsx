    ...
    <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6">
      <div className="rounded-2xl bg-primary px-8 py-16 text-center text-primary-foreground space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Button asChild size="lg" variant="outline" className="gap-2 h-12 px-8 border-primary-foreground/30 text-primary-foreground hover:bg-primary-foreground/10">
            <Link href="/properties">{cta.secondary}</Link>
          </Button>
        </div>
      </div>
    </section>
