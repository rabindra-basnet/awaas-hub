...
// // // lib/property/property-shared.ts
...
//   // ── NEW: exact GPS coordinates for Google Maps pin ──
//   latitude?: number;
//   longitude?: number;
...
//   // ── GPS coordinates — used by Google Maps embed & virtual tour ────────────
//   latitude: {
//     type: Number,
//     default: null,
//     min: -90,
...
// PropertySchema.index({ category: 1, status: 1 });
// PropertySchema.index({ location: 1, status: 1 });
// // Sparse index for geolocation queries (only indexes documents that have both fields)
